...
**ShadowStore** 是一个面向 Shadowrocket 的 **第三方开源资源索引与检索平台**。

ShadowStore 致力于解决开源资源分散、检索困难、版本追踪不易的问题。平台坚持以下核心原则：
...
* 📦 **资源聚合，分类检索**：收录去广告、流媒体解锁检测、日常签到、实用插件等全场景，打造丰富的第三方资源库。
...
* 🔄 **自动化健康检查**：定时自检收录链接的有效性，自动标识失效或迁移资源，保持索引库新鲜度。
...
2. **知识产权归属**：所有被收录资源的名称、脚本代码及版权均归原作者或对应版权方所有。
3. **使用风险自负**：各资源的功能与有效性由其原作者维护，请使用者自行甄别资源安全性，并遵守相关法律法规及开源协议。
